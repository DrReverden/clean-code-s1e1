...
var taskInput=document.querySelector(".check-item__input");//Add a new task.
var addButton=document.querySelector(".check-item__button");//first button
...
var editTask=function(){
    ...
    editInput.classList.add('add-item__input')
